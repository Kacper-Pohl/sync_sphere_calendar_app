  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 text-center">
      ...
      <header className="hero max-w-2xl">
        <div className="mb-10 inline-flex items-center justify-center rounded-3xl bg-white/[0.03] p-6 border border-white/5 backdrop-blur-sm">
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500/80">
      ...
      <footer className="absolute bottom-8 text-xs text-slate-500 font-medium tracking-widest uppercase">
